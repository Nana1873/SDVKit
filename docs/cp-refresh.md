...
does that, the existing staging-drift guard rejects refresh. Stop/reset that review,
deliberately adopt the generated config in your selected sources, and start again.
