...
```powershell
.\scripts\verify-windows-x64.ps1 -ArchivePath .\.sdvkit\release\SDVKit-0.10.2-win-x64.zip -ExpectedVersion 0.10.2 -ExpectedDoctorStatus ready
```
...
```powershell
.\scripts\release-notes.ps1 -Version 0.10.2 | Set-Content -LiteralPath .\.sdvkit\release-notes.md -Encoding utf8
```
