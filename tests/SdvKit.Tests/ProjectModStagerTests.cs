...
public sealed class ProjectModStagerTests
{
    ...
    [InlineData("0.5.3", null)]
    [InlineData("0.5.4", null)]
    [InlineData("0.6.0", null)]
    [InlineData("0.6.1", null)]
    [InlineData("0.6.2", null)]
    [InlineData("0.7.0", null)]
    [InlineData("0.7.1", null)]
    [InlineData("0.8.0", null)]
    [InlineData("0.8.1", null)]
    [InlineData("0.9.0", null)]
    [InlineData("0.9.1", null)]
    [InlineData("0.10.1", null)]
    [InlineData("0.10.2", "runtimeDependencyUnavailable")]
